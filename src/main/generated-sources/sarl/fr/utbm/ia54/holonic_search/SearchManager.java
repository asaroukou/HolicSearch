...
import fr.utbm.ia54.holonic_search.SearchAgent;
...
public class SearchManager extends Agent {
  private String path = "/home/users/ambyassa/sarl_dir";
  
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.setLoggingName("SearchManager");
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1 = this.$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1.info("The manager start.");
    Lifecycle _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER = this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawn(SearchAgent.class, this.path);
  }
  
  private void $behaviorUnit$ParticipantJoined$1(final ParticipantJoined occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER();
    UUID _uUID = occurrence.getSource().getUUID();
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info(("participant join: " + _uUID));
  }
  ...
  @Inject
  @Deprecated
  public SearchManager(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
